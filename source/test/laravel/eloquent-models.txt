...
Previous: `<laravel-installation`__
...
Just like a normal model, the MongoDB model class will know which collection
...
database connection that should be used when utilizing the model.
...
need to use the ``MongoDB\Laravel\Eloquent\MassPrunable`` trait instead: it
...
The inverse relation is auto\ *magically* available. You don't need to define
this reverse relation.
